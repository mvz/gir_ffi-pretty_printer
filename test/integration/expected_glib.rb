module GLib
  ...
  class GLib::BookmarkFile < GirFFI::StructBase
    ...
    def get_app_info(uri, name)
      ...
      _v8 = _v3.get_pointer(0).tap { |it| it.autorelease = true }.to_utf8
    ...
    def get_description(uri)
      ...
      GirFFI::ArgHelper.check_error(_v2)
      _v4 = _v3.tap { |it| it.autorelease = true }.to_utf8
      return _v4
    end
    def get_groups(uri)
      _v1 = GirFFI::InPointer.from_utf8(uri)
    ...
    def get_icon(uri)
      ...
      _v6 = _v2.get_pointer(0).tap { |it| it.autorelease = true }.to_utf8
      _v7 = _v3.get_pointer(0).tap { |it| it.autorelease = true }.to_utf8
      return [_v5, _v6, _v7]
    end
    ...
    def load_from_data_dirs(file, full_path = nil)
      _v1 = GirFFI::InPointer.from_utf8(file)
      _v2 = GirFFI::InPointer.from_utf8(full_path)
      _v3 = FFI::MemoryPointer.new(:pointer).write_pointer(nil)
    ...
    def to_data
      ...
      _v5 = _v3.tap { |it| it.autorelease = true }.to_utf8
      return [_v5, _v4]
    end
  ...
  class GLib::IOChannel < GirFFI::BoxedBase
    ...
    def read_line
      ...
      GirFFI::ArgHelper.check_error(_v4)
      _v6 = _v1.get_pointer(0).tap { |it| it.autorelease = true }.to_utf8
  ...
  class GLib::KeyFile < GirFFI::BoxedBase
    ...
    def get_comment(group_name, key)
      ...
      GirFFI::ArgHelper.check_error(_v3)
      _v5 = _v4.tap { |it| it.autorelease = true }.to_utf8
      return _v5
    end
    ...
    def get_locale_string(group_name, key, locale = nil)
      ...
      GirFFI::ArgHelper.check_error(_v4)
      _v6 = _v5.tap { |it| it.autorelease = true }.to_utf8
      return _v6
    end
    ...
    def load_from_data_dirs(file, flags)
      ...
      GirFFI::ArgHelper.check_error(_v4)
      _v6 = _v2.get_filename(0).tap { |it| it.autorelease = true }.to_utf8
      return [_v5, _v6]
    end
    def load_from_dirs(file, search_dirs, flags)
      ...
      GirFFI::ArgHelper.check_error(_v5)
      _v7 = _v3.get_filename(0).tap { |it| it.autorelease = true }.to_utf8
      return [_v6, _v7]
    end
  ...
  class GLib::MainContext < GirFFI::BoxedBase
    ...
    def query(max_priority)
      ...
      _v6 = _v2.get_int32(0)
      _v7 = _v3.get_int32(0)
      _v8 = GirFFI::SizedArray.wrap(GLib::PollFD, _v7, _v4.get_pointer(0))
      return [_v5, _v6, _v8]
    end
    def ref
  ...
  class GLib::Regex < GirFFI::BoxedBase
    ...
    def replace(string, start_position, replacement, match_options)
      ...
      GirFFI::ArgHelper.check_error(_v6)
      _v8 = _v7.tap { |it| it.autorelease = true }.to_utf8
      return _v8
    end
  ...
  class GLib::Variant < GirFFI::StructBase
    ...
    def dup_string
      ...
      _v3 = _v1.get_uint64(0)
      _v4 = _v2.tap { |it| it.autorelease = true }.to_utf8
      return [_v4, _v3]
    end
    def dup_strv
      _v1 = FFI::MemoryPointer.new(:uint64)
  ...
  class GLib::VariantBuilder < GirFFI::BoxedBase
    ...
    def x
      _v1 = (@struct.to_ptr + 0)
      _v2 = GirFFI::SizedArray.get_value_from_pointer(_v1, 0)
      _v3 = GirFFI::SizedArray.wrap(:guint64, 16, _v2)
      _v3
    end
  end
  # XXX: Don't know how to print enum
  ...
  class GLib::VariantType < GirFFI::BoxedBase
    ...
    def self.string_scan(string, limit = nil)
      ...
      _v5 = _v3.get_pointer(0).tap { |it| it.autorelease = true }.to_utf8
      return [_v4, _v5]
    end
    def copy
  ...
  def self.ascii_strtod(nptr, endptr)
    ...
    _v2 = GirFFI::InPointer.from_utf8(endptr)
  ...
  def self.basename(file_name)
    _v1 = GirFFI::InPointer.from_utf8(file_name)
  ...
  def self.compute_hmac_for_data(digest_type, key, data, length)
    ...
    _v7 = _v6.tap { |it| it.autorelease = true }.to_utf8
    return _v7
  end
  ...
  def self.convert(str, len, to_codeset, from_codeset)
    ...
    _v11 = _v8.tap { |it| it.autorelease = true }.to_utf8
  ...
  def self.convert_with_fallback(str, len, to_codeset, from_codeset, fallback, bytes_read, bytes_written)
    ...
    _v10 = _v9.tap { |it| it.autorelease = true }.to_utf8
    return _v10
  end
  ...
  def self.file_open_tmp(tmpl = nil)
    ...
    GirFFI::ArgHelper.check_error(_v3)
    _v5 = _v2.get_filename(0).tap { |it| it.autorelease = true }.to_utf8
    return [_v4, _v5]
  end
  ...
  def self.filename_from_uri(uri)
    ...
    GirFFI::ArgHelper.check_error(_v3)
    _v5 = _v2.get_pointer(0).tap { |it| it.autorelease = true }.to_utf8
    _v6 = _v4.tap { |it| it.autorelease = true }.to_utf8
    return [_v6, _v5]
  end
  ...
  def self.find_program_in_path(program)
    _v1 = GirFFI::InPointer.from_utf8(program)
  ...
  def self.mkdir_with_parents(pathname, mode)
    _v1 = GirFFI::InPointer.from_utf8(pathname)
    _v2 = mode
  ...
  def self.return_if_fail_warning(log_domain, pretty_function, expression)
    _v1 = GirFFI::InPointer.from_utf8(log_domain)
    _v2 = GirFFI::InPointer.from_utf8(pretty_function)
    _v3 = GirFFI::InPointer.from_utf8(expression)
  ...
  def self.spawn_async(working_directory, argv, envp, flags, &child_setup)
    _v1 = GirFFI::InPointer.from_utf8(working_directory)
  ...
  def self.unichar_to_utf8(c, outbuf)
    _v1 = c
    _v2 = GirFFI::InPointer.from_utf8(outbuf)
  ...
  def self.warn_message(domain, file, line, func, warnexpr)
    ...
    _v3 = line
    _v4 = GirFFI::InPointer.from_utf8(func)
    _v5 = GirFFI::InPointer.from_utf8(warnexpr)
